...
import Today_Question_Back from '../../assets/images/Today_Question_Back.png';
...
const ForestQuestion = () => {
  ...
  return (
    <div className="ForestQuestion">
      <div className="forest_todayquestion">
        <img src={Today_Question_Back} alt="Today Question Background" />
      </div>
